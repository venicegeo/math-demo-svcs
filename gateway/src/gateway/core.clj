(ns gateway.core
  ...
  (:require [com.stuartsierra.component :as c]
            ...
            [gateway.components :as components]))

(defn init [options]
  (alter-var-root #'gateway.system/current-system (constantly (components/system options))))

(defn start []
  (alter-var-root #'gateway.system/current-system c/start))

(defn stop []
  (alter-var-root #'gateway.system/current-system #(when % (c/stop %) nil)))
